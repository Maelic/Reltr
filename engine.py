...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for samples, targets in data_loader:
        ...
        # log loss and error to wandb
        wandb.log({"loss": loss_value, "class_error": loss_dict_reduced['class_error'],
                     "sub_error": loss_dict_reduced['sub_error'], "obj_error": loss_dict_reduced['obj_error'],
                     "rel_error": loss_dict_reduced['rel_error'], "lr": optimizer.param_groups[0]["lr"]})
